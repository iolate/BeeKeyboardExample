...
#define KEY_BRIGHTUP7 71 //maybe only working on Mac
#define KEY_BRIGHTDOWN7 72 //maybe only working on Mac
...
#define KEY_REWIND2 182 //same as REWIND(180)
#define KEY_EJECT 184
#define KEY_SHOW_HIDE_KEYBOARD //same keycode with EJECT
#define KEY_PLAYPAUSE 205
#define KEY_MUTE 226
#define KEY_VOLUMEUP 233
